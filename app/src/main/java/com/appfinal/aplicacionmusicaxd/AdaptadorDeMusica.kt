...
class AdaptadorDeMusica(private val contexto: Context, private val listaDeCanciones: ArrayList<String>) : RecyclerView.Adapter<AdaptadorDeMusica.MiTitular>(){
    ...
    {
        holder.titulo.text = listaDeCanciones[position]
    }
